...
import placard.fr.eu.chacunsapart.backend.beans.Groups;
import placard.fr.eu.chacunsapart.backend.beans.LoginResponse;
import placard.fr.eu.chacunsapart.backend.data.DataManager;
